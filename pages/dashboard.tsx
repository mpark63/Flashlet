...
import Flashlet from "../components/Flashlet";
...
const Dashboard: NextPage = () => {
  ...
  const getDecksJSX = (decks: Deck[]): JSX.Element[] => {
  ...
  return (
    <>
      ...
      <Flashlet /> 
      <main className="flex min-h-screen flex-col p-20 bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <h1 className="text-5xl font-extrabold tracking-tight text-white text-center sm:text-[5rem]">
          My Decks
        </h1>
        <h3 className="font-extrabold tracking-tight text-center text-white sm:text-[2rem]">
          Signed in as {user._id}
        </h3>
        <div className="container flex flex-col justify-center items-center gap-12 px-4 py-8 ">
          <div className="grid grid-flow-col auto-cols-fr gap-4 md:gap-8">
        ...
        <div className="container flex flex-col justify-center items-center gap-12 px-4 py-8 ">
          <div className="grid grid-cols-4 auto-cols-fr gap-4 md:gap-8">
            {decksJSX && decksJSX.length ? (
              decksJSX
            ) : (
              null 
            ) }
